...
export class PeContactsHeaderService extends BaseHeaderService {
  constructor(
    ...
    console.log('creating contacts header service instance');
  }
  ...
  init(): void {
    ...
    this.setHeaderConfig({
      ...
      currentMicroBaseUrl: this.envService.businessData ? `/business/${this.envService.businessData._id}/contacts` : '',
