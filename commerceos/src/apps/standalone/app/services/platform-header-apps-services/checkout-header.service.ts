...
export class PeCheckoutHeaderService extends BaseHeaderService {
  constructor(
    ...
    console.log('creating common header service instance'); // TODO Remove
  }
  ...
  getHeaderConfig(): PePlatformHeaderConfig {
    ...
    return {
      ...
      currentMicroBaseUrl: this.envService.businessData ? `/business/${this.envService.businessData._id}/checkout` : '',
      ...
      rightSectionItems: [
        ...
        },
        {
          ...
          iconSize: '14px',
          iconType: 'vector',
          class: 'checkout-header-hamburger-icon',
          children: [
            {
