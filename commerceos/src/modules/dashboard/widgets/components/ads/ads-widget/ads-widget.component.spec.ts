...
import { AdsWidgetComponent } from '..';
import { BehaviorSubject } from 'rxjs';

describe('AdsWidgetComponent', function () {
  let comp: AdsWidgetComponent;
  ...
  describe('Widget Ads content', () => {
    ...
    it('should render the buy now button', () => {
      fixture.detectChanges();
      const element = fixture.debugElement
        .query(By.css('.install-ads.mat-button-rect-md.mat-button-no-padding'));
      expect(element).not.toBeNull();
    });

  });

  describe('Widget Ads actions', () => {
