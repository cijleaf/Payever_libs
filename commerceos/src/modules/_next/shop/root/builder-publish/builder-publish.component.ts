...
export class PeShopBuilderPublishComponent implements OnInit, OnDestroy {
  ...
  constructor(
    public dialogRef: MatDialogRef<PeShopBuilderPublishComponent>,
  ...
  ngOnInit() {
    ...
    this.editorApi.getShopActiveTheme(this.data.shop).subscribe(
      data=>this.getSnapshot(data.theme),
      err=>{
